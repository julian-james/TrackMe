...
describe("login.html", () => {
    ...
    describe('head', () => {
        it('has a title', () => {
            ...
            expect(title.textContent).toBe("TrackMe")
        })
    })
    ...
    describe("body", () => {
        describe('header', () => {
            ...
            it("has the right title", () => {
                ...
                expect(heading.textContent).toEqual("TrackMe");
            })
        })
        ...
        describe('register form', () => {
            ...
            it("has an input for email", () => {
                expect(emailInput).toBeTruthy();
                expect(emailInput.name).toEqual("UserEmail")
                expect(emailInput.placeholder).toEqual("UserEmail")
            })
